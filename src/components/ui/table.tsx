...
function TableHeader({ className, ...props }: React.ComponentProps<"thead">) {
  return (
    <thead
      ...
      className={cn("[&_tr]:border-b [&_tr]:border-[#dbe3ed]", className)}
      {...props}
    />
  )
}
...
function TableFooter({ className, ...props }: React.ComponentProps<"tfoot">) {
  return (
    <tfoot
      ...
      className={cn(
        "border-t border-[#dbe3ed] bg-[#fff8e6] font-medium text-[#33475c] [&>tr]:last:border-b-0",
        className
      )}
      {...props}
    />
...
function TableCaption({
  ...
  return (
    <caption
      ...
      className={cn("mt-4 text-sm text-[#5a6c82]", className)}
      {...props}
    />
  )
}
