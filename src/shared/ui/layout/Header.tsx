  ...
  return (
    <header className="flex h-14 items-center gap-4 border-b bg-background px-4">
      ...
      <div className="flex-1 min-w-0">
        <p className="truncate text-sm font-semibold leading-none">{tituloUE}</p>
      ...
      {/* Menú de usuario */}
      <DropdownMenu>
        <DropdownMenuTrigger className="inline-flex h-8 items-center gap-1.5 rounded-md px-2.5 text-sm font-medium transition-colors hover:bg-muted outline-none focus-visible:ring-2 focus-visible:ring-ring">
